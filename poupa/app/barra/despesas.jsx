...
const styles = StyleSheet.create({
  ...
  blackCard: { backgroundColor: colors.surface, padding: 24, borderRadius: radius.lg, marginBottom: 25, ...shadows.card },
  cardLabel: { color: colors.muted, fontSize: 14, fontWeight: '600' },
  cardValue: { fontSize: 32, fontWeight: 'bold', color: colors.ink, marginTop: 4 },
